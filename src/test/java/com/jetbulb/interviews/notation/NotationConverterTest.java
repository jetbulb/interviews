...
import com.jetbulb.interviews.notation.InvalidValueException;
import com.jetbulb.interviews.notation.NotationConverter;
...
public class NotationConverterTest {
    ...
    void shouldSuccessfullyConvertRomanToArabicNotation(String roman, int arabic) {
